...
<style>
    ...
    <div class="row justify-content-center text-center">
            <div class="col-4">
                ...
                <p>Sambrano Hinojo, Alexis<br>(Desarrollador Frontend - Analista)</p>
            </div>
            <div class="col-4">
            ...
            <div class="col-4">
                ...
                <p>Vallejo Pablo,Nilo Brayan<br>(Desarrollador Backend - Jefe de Testing)</p>
            </div>

            <div class="col-4">
                <img src="https://cronicaglobal.elespanol.com/uploads/s1/54/71/44/2/persona-usando-un-macbook.png"class="img-fluid foto" alt="">
                <p>Alvarez Levano, Jose Reymundo<br>(Desarrollador Frontend)</p>
            </div>
     </div>
